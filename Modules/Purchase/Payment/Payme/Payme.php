...
use Modules\Purchase\Payment\Payme\MerchantApiMethods\CancelTransaction;
use Modules\Purchase\Payment\Payme\MerchantApiMethods\CheckPerformTransaction;
use Modules\Purchase\Payment\Payme\MerchantApiMethods\CheckTransaction;
use Modules\Purchase\Payment\Payme\MerchantApiMethods\CreateTransaction;
use Modules\Purchase\Payment\Payme\MerchantApiMethods\PerformTransaction;
use function config;
...
class Payme
{
    ...
    {
        return Purchase::query()->find($this->request->params['account'][$this->config['key']]);
    }
